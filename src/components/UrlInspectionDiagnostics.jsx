...
export function UrlAlignmentMatrix({ report, inspectionResults, copy, Badge }) {
...
export function IndexCoveragePriorities({ report, inspectionResults, gscRows, copy, Badge }) {
...
export function ImportantPageFreshness({ inspectionResults, gscRows, copy, Badge }) {
