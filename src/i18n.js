...
export const dictionaries = {
  en: {
    heading: "SEO Command Center",
    subheading: "Technical SEO diagnosis and Google data analysis.",
    productSignalsLabel: "Diagnostic signals",
    signalIndexing: "Indexing intelligence",
    signalPerformance: "PageSpeed evidence",
    signalSearchConsole: "GSC-ready workflow",
    placeholder: "https://example.com, /sitemap.xml, or /robots.txt",
    skipToContent: "Skip to main content",
    languageLabel: "Interface language",
    auditUrlLabel: "Website, sitemap, or robots.txt URL",
    audit: "Audit",
    scanCommandHelp: "Supports a homepage, sitemap.xml, or robots.txt. IndexPilot detects the sitemap, robots rules, and site entry automatically.",
    emptyReportTitle: "Run an audit first",
    emptyReportHelp: "Issues and URL diagnostics appear after soos scans a website, sitemap, or robots.txt file.",
    emptyReportAction: "Go to Scan",
    scanStepsTitle: "Audit workflow",
    scanStepSettings: "Review settings",
    scanStepSettingsHelp: "Choose crawl depth and optional evidence sources before running the audit.",
    scanStepRun: "Run the audit",
    scanStepRunHelp: "Start with a site, sitemap, or robots.txt URL.",
    scanStepEvidence: "Add Google evidence",
    scanStepEvidenceHelp: "Connect GSC or PageSpeed when you need confirmed search and performance data.",
    pageChecksTitle: "Page content checks",
    pageChecksHelp: "Title, description, H1, lang, viewport, JSON-LD, and duplicate metadata",
    rawHtmlBoundaryTitle: "Raw HTML boundary",
    rawHtmlBoundaryHelp: "Canonical, hreflang, noindex, links, and structured data are read from the server response. JavaScript-rendered changes are not included.",
    ...
    fixFirst: "Fix First",
    fixPlan: "Fix Plan",
    exportFixPlan: "Export fix plan",
    noUnifiedIssues: "No prioritized issues found in the current evidence set.",
    noOpenIssues: "All prioritized issues are marked resolved or ignored.",
    closedIssueDecisions: "Resolved or ignored decisions",
    ...
    coverageTrustStrong: "Strong evidence",
    coverageTrustModerate: "Moderate evidence",
    coverageTrustLimited: "Limited evidence",
    coverageScanned: "Scanned URLs",
    coverageSitemapUrls: "Sitemap URLs",
    coverageInspected: "Inspected URLs",
    coverageSignals: "Evidence sources",
    coverageLocalOnlyTitle: "Local SEO diagnosis is still available",
    coverageLocalOnlyHelp: "Sitemap, robots.txt, HTTP status, canonical, hreflang, structured data, and HTML checks do not require Search Console. Connect Google only when you need confirmed indexing and performance evidence.",
    coverageLocalScan: "Local scan",
    coverageRobots: "robots.txt",
    coverageSitemap: "Sitemap XML",
    coverageInternalLinks: "Internal links",
    coverageSearchConsole: "Search Console",
    coverageUrlInspection: "URL Inspection sample",
    coveragePageSpeed: "PageSpeed",
    coverageCrux: "CrUX",
    coverageLimitations: "Coverage limits",
    coverageCannotConclude: "Do not conclude",
    coverageNoLimitations: "No major coverage limits detected.",
    coverageNoUnsafeConclusions: "No extra unsafe conclusions flagged.",
    coverageLimitTruncated: "The scan hit a configured sitemap, URL, or internal discovery limit.",
    coverageLimitInternalOff: "Recursive internal discovery was not enabled.",
    coverageLimitGscOff: "Google Search Console data was not connected for this report.",
    coverageLimitInspectionOff: "URL Inspection has not checked representative URLs for this report.",
    coverageLimitInspectionSubset: "URL Inspection covers only a subset of candidate URLs.",
    coverageLimitPageSpeedOff: "PageSpeed Insights was not run.",
    coverageLimitCruxOff: "CrUX field data was not loaded.",
    coverageCannotUnscannedHealthy: "Do not treat missing findings as proof that the unscanned URL set is healthy.",
    coverageCannotReachability: "Do not conclude that sitemap pages are reachable from the homepage unless link graph data exists.",
    coverageCannotGoogleConfirmed: "Do not label issues as Google-confirmed without URL Inspection or Search Analytics evidence.",
    coverageCannotFullIndexing: "Do not claim full-site Google indexing status from local scan data alone.",
    coverageCannotGeneralizeInspection: "Do not generalize inspected URL results to every URL in the sitemap.",
    coverageCannotLighthouse: "Do not infer Lighthouse lab performance or SEO audit status from lightweight HTML signals.",
    coverageCannotCrux: "Do not infer real-user Core Web Vitals from this report.",
    ...
    externalAffectedUrls: "Affected URLs outside this scan",
    externalAffectedUrlsHelp: "These URLs came from Google evidence or a comparison report, but they are not present in the current scanned URL list.",
    impact: "Impact",
    evidence: "Evidence",
    fixSteps: "Fix steps",
    verifySteps: "Verify",
    ...
    showFewerIssues: "Show fewer issues",
  ...
  "zh-CN": {
    heading: "SEO \u667a\u80fd\u8bca\u65ad\u53f0",
    subheading: "\u6280\u672f SEO \u8bca\u65ad\u4e0e Google \u6570\u636e\u5206\u6790\u3002",
    productSignalsLabel: "\u8bca\u65ad\u4fe1\u53f7",
    signalIndexing: "\u7d22\u5f15\u667a\u80fd\u5206\u6790",
    signalPerformance: "PageSpeed \u8bc1\u636e",
    signalSearchConsole: "GSC \u5de5\u4f5c\u6d41",
    placeholder: "https://example.com\u3001/sitemap.xml \u6216 /robots.txt",
    skipToContent: "\u8df3\u5230\u4e3b\u8981\u5185\u5bb9",
    languageLabel: "\u754c\u9762\u8bed\u8a00",
    auditUrlLabel: "\u7f51\u7ad9\u3001sitemap \u6216 robots.txt \u7f51\u5740",
    audit: "\u5f00\u59cb\u68c0\u67e5",
    scanCommandHelp: "\u652f\u6301\u7f51\u7ad9\u9996\u9875\u3001sitemap.xml \u6216 robots.txt\uff0cIndexPilot \u4f1a\u81ea\u52a8\u8bc6\u522b sitemap\u3001robots \u548c\u7ad9\u70b9\u5165\u53e3\u3002",
    emptyReportTitle: "\u8bf7\u5148\u8fd0\u884c\u68c0\u67e5",
    emptyReportHelp: "soos \u626b\u63cf\u7f51\u7ad9\u3001sitemap \u6216 robots.txt \u540e\uff0c\u624d\u4f1a\u663e\u793a\u95ee\u9898\u548c URL \u8bca\u65ad\u3002",
    emptyReportAction: "\u8fd4\u56de\u626b\u63cf",
    scanStepsTitle: "\u68c0\u67e5\u6d41\u7a0b",
    scanStepSettings: "\u5148\u770b\u8bbe\u7f6e",
    scanStepSettingsHelp: "\u8fd0\u884c\u524d\u786e\u8ba4\u6293\u53d6\u8303\u56f4\u548c\u53ef\u9009\u8bc1\u636e\u6765\u6e90\u3002",
    scanStepRun: "\u5f00\u59cb\u626b\u63cf",
    scanStepRunHelp: "\u8f93\u5165\u7f51\u7ad9\u3001sitemap \u6216 robots.txt \u7f51\u5740\u3002",
    scanStepEvidence: "\u8865\u5145 Google \u8bc1\u636e",
    scanStepEvidenceHelp: "\u9700\u8981\u786e\u8ba4\u641c\u7d22\u548c\u6027\u80fd\u6570\u636e\u65f6\uff0c\u518d\u8fde\u63a5 GSC \u6216 PageSpeed\u3002",
    pageChecksTitle: "\u9875\u9762\u5185\u5bb9\u68c0\u67e5",
    pageChecksHelp: "Title\u3001description\u3001H1\u3001lang\u3001viewport\u3001JSON-LD \u548c\u91cd\u590d\u5143\u6570\u636e",
    rawHtmlBoundaryTitle: "\u539f\u59cb HTML \u68c0\u67e5\u8fb9\u754c",
    rawHtmlBoundaryHelp: "Canonical\u3001hreflang\u3001noindex\u3001\u94fe\u63a5\u548c\u7ed3\u6784\u5316\u6570\u636e\u6765\u81ea\u670d\u52a1\u5668\u54cd\u5e94\uff0c\u4e0d\u5305\u542b JavaScript \u6e32\u67d3\u540e\u7684\u53d8\u5316\u3002",
    ...
    fixFirst: "\u4f18\u5148\u4fee\u590d",
    fixPlan: "修复计划",
    exportFixPlan: "导出修复计划",
    noUnifiedIssues: "当前证据集中没有发现需要优先处理的问题。",
    noOpenIssues: "所有优先问题都已标记为已解决或已忽略。",
    closedIssueDecisions: "已解决或已忽略的决策",
    markResolved: "标记已解决",
    ignoreIssue: "忽略",
    reopenIssue: "重新打开",
    resolved: "已解决",
    ignored: "已忽略",
    priorityScore: "优先级",
    reportCoverage: "报告覆盖范围",
    coverageTrustStrong: "证据较强",
    coverageTrustModerate: "证据中等",
    coverageTrustLimited: "证据有限",
    coverageScanned: "已扫描网址",
    coverageSitemapUrls: "Sitemap 网址",
    coverageInspected: "已检查网址",
    coverageSignals: "证据来源",
    coverageLocalOnlyTitle: "本地 SEO 诊断仍然可用",
    coverageLocalOnlyHelp: "Sitemap、robots.txt、HTTP 状态、canonical、hreflang、结构化数据和 HTML 检查不需要 Search Console。只有需要确认 Google 收录和搜索表现证据时再连接 Google。",
    coverageLocalScan: "本地扫描",
    coverageRobots: "robots.txt",
    coverageSitemap: "Sitemap XML",
    coverageInternalLinks: "站内链接",
    coverageSearchConsole: "Search Console",
    coverageUrlInspection: "URL Inspection 样本",
    coveragePageSpeed: "PageSpeed",
    coverageCrux: "CrUX",
    coverageLimitations: "覆盖限制",
    coverageCannotConclude: "不能据此断言",
    coverageNoLimitations: "未发现主要覆盖限制。",
    coverageNoUnsafeConclusions: "未标记额外的不安全结论。",
    coverageLimitTruncated: "本次扫描触及 sitemap、URL 或站内发现的配置上限。",
    coverageLimitInternalOff: "未启用递归站内发现。",
    coverageLimitGscOff: "本报告未连接 Google Search Console 数据。",
    coverageLimitInspectionOff: "URL Inspection 尚未检查代表性网址。",
    coverageLimitInspectionSubset: "URL Inspection 只覆盖候选网址的一部分。",
    coverageLimitPageSpeedOff: "未运行 PageSpeed Insights。",
    coverageLimitCruxOff: "未加载 CrUX 真实用户数据。",
    coverageCannotUnscannedHealthy: "不能把未发现问题当作未扫描网址集合健康的证明。",
    coverageCannotReachability: "除非存在链接图数据，否则不能断言 sitemap 页面可从首页到达。",
    coverageCannotGoogleConfirmed: "没有 URL Inspection 或 Search Analytics 证据时，不能标记为 Google 已确认。",
    coverageCannotFullIndexing: "不能仅凭本地扫描断言全站 Google 收录状态。",
    coverageCannotGeneralizeInspection: "不能把已检查 URL 的结果泛化到 sitemap 中每个 URL。",
    coverageCannotLighthouse: "不能从轻量 HTML 信号推断 Lighthouse 实验室性能或 SEO 审计状态。",
    coverageCannotCrux: "不能从本报告推断真实用户 Core Web Vitals。",
    confidence: "可信度",
    confirmed: "已确认",
    likely: "较可信",
    inferred: "推断",
    category: "分类",
    affectedUrls: "受影响网址",
    externalAffectedUrls: "本次扫描外的受影响网址",
    externalAffectedUrlsHelp: "这些网址来自 Google 证据或历史对比，但不在当前已扫描 URL 列表中。",
    impact: "影响",
    evidence: "证据",
    fixSteps: "修复步骤",
    verifySteps: "验证",
    tasks: "\u9879\u4efb\u52a1",
    showAllIssues: "显示全部问题",
    showFewerIssues: "收起问题",
  ...
  "zh-TW": {
    heading: "SEO \u667a\u80fd\u8a3a\u65b7\u53f0",
    subheading: "\u6280\u8853 SEO \u8a3a\u65b7\u8207 Google \u8cc7\u6599\u5206\u6790\u3002",
    productSignalsLabel: "\u8a3a\u65b7\u8a0a\u865f",
    signalIndexing: "\u7d22\u5f15\u667a\u80fd\u5206\u6790",
    signalPerformance: "PageSpeed \u8b49\u64da",
    signalSearchConsole: "GSC \u5de5\u4f5c\u6d41",
    placeholder: "https://example.com\u3001/sitemap.xml \u6216 /robots.txt",
    ...
    audit: "\u958b\u59cb\u6aa2\u67e5",
    scanCommandHelp: "\u652f\u6301\u7db2\u7ad9\u9996\u9801\u3001sitemap.xml \u6216 robots.txt\uff0cIndexPilot \u6703\u81ea\u52d5\u8b58\u5225 sitemap\u3001robots \u548c\u7ad9\u9ede\u5165\u53e3\u3002",
    emptyReportTitle: "\u8acb\u5148\u57f7\u884c\u6aa2\u67e5",
    emptyReportHelp: "soos \u6383\u63cf\u7db2\u7ad9\u3001sitemap \u6216 robots.txt \u5f8c\uff0c\u624d\u6703\u986f\u793a\u554f\u984c\u548c URL \u8a3a\u65b7\u3002",
    emptyReportAction: "\u56de\u5230\u6383\u63cf",
    scanStepsTitle: "\u6aa2\u67e5\u6d41\u7a0b",
    scanStepSettings: "\u5148\u770b\u8a2d\u5b9a",
    scanStepSettingsHelp: "\u57f7\u884c\u524d\u78ba\u8a8d\u6aa2\u7d22\u7bc4\u570d\u548c\u9078\u7528\u8b49\u64da\u4f86\u6e90\u3002",
    scanStepRun: "\u958b\u59cb\u6383\u63cf",
    scanStepRunHelp: "\u8f38\u5165\u7db2\u7ad9\u3001sitemap \u6216 robots.txt \u7db2\u5740\u3002",
    scanStepEvidence: "\u88dc\u5145 Google \u8b49\u64da",
    scanStepEvidenceHelp: "\u9700\u8981\u78ba\u8a8d\u641c\u5c0b\u548c\u6548\u80fd\u8cc7\u6599\u6642\uff0c\u518d\u9023\u63a5 GSC \u6216 PageSpeed\u3002",
    pageChecksTitle: "\u9801\u9762\u5167\u5bb9\u6aa2\u67e5",
    pageChecksHelp: "Title\u3001description\u3001H1\u3001lang\u3001viewport\u3001JSON-LD \u548c\u91cd\u8907\u4e2d\u7e7c\u8cc7\u6599",
    rawHtmlBoundaryTitle: "\u539f\u59cb HTML \u6aa2\u67e5\u908a\u754c",
    rawHtmlBoundaryHelp: "Canonical\u3001hreflang\u3001noindex\u3001\u9023\u7d50\u548c\u7d50\u69cb\u5316\u8cc7\u6599\u4f86\u81ea\u4f3a\u670d\u5668\u56de\u61c9\uff0c\u4e0d\u5305\u542b JavaScript \u6e32\u67d3\u5f8c\u7684\u8b8a\u5316\u3002",
    ...
    fixFirst: "\u512a\u5148\u4fee\u5fa9",
    fixPlan: "修復計畫",
    exportFixPlan: "匯出修復計畫",
    noUnifiedIssues: "目前證據集中沒有發現需要優先處理的問題。",
    noOpenIssues: "所有優先問題都已標記為已解決或已忽略。",
    closedIssueDecisions: "已解決或已忽略的決策",
    markResolved: "標記已解決",
    ignoreIssue: "忽略",
    reopenIssue: "重新開啟",
    resolved: "已解決",
    ignored: "已忽略",
    priorityScore: "優先級",
    reportCoverage: "報告涵蓋範圍",
    coverageTrustStrong: "證據較強",
    coverageTrustModerate: "證據中等",
    coverageTrustLimited: "證據有限",
    coverageScanned: "已掃描網址",
    coverageSitemapUrls: "Sitemap 網址",
    coverageInspected: "已檢查網址",
    coverageSignals: "證據來源",
    coverageLocalOnlyTitle: "本地 SEO 診斷仍然可用",
    coverageLocalOnlyHelp: "Sitemap、robots.txt、HTTP 狀態、canonical、hreflang、結構化資料和 HTML 檢查不需要 Search Console。只有需要確認 Google 收錄和搜尋成效證據時再連接 Google。",
    coverageLocalScan: "本地掃描",
    coverageRobots: "robots.txt",
    coverageSitemap: "Sitemap XML",
    coverageInternalLinks: "站內連結",
    coverageSearchConsole: "Search Console",
    coverageUrlInspection: "URL Inspection 樣本",
    coveragePageSpeed: "PageSpeed",
    coverageCrux: "CrUX",
    coverageLimitations: "涵蓋限制",
    coverageCannotConclude: "不能據此斷言",
    coverageNoLimitations: "未發現主要涵蓋限制。",
    coverageNoUnsafeConclusions: "未標記額外的不安全結論。",
    coverageLimitTruncated: "本次掃描觸及 sitemap、URL 或站內發現的設定上限。",
    coverageLimitInternalOff: "未啟用遞迴站內發現。",
    coverageLimitGscOff: "本報告未連接 Google Search Console 資料。",
    coverageLimitInspectionOff: "URL Inspection 尚未檢查代表性網址。",
    coverageLimitInspectionSubset: "URL Inspection 只涵蓋候選網址的一部分。",
    coverageLimitPageSpeedOff: "未執行 PageSpeed Insights。",
    coverageLimitCruxOff: "未載入 CrUX 真實使用者資料。",
    coverageCannotUnscannedHealthy: "不能把未發現問題當作未掃描網址集合健康的證明。",
    coverageCannotReachability: "除非存在連結圖資料，否則不能斷言 sitemap 頁面可從首頁到達。",
    coverageCannotGoogleConfirmed: "沒有 URL Inspection 或 Search Analytics 證據時，不能標記為 Google 已確認。",
    coverageCannotFullIndexing: "不能僅憑本地掃描斷言全站 Google 收錄狀態。",
    coverageCannotGeneralizeInspection: "不能把已檢查 URL 的結果泛化到 sitemap 中每個 URL。",
    coverageCannotLighthouse: "不能從輕量 HTML 信號推斷 Lighthouse 實驗室效能或 SEO 審計狀態。",
    coverageCannotCrux: "不能從本報告推斷真實使用者 Core Web Vitals。",
    confidence: "可信度",
    confirmed: "已確認",
    likely: "較可信",
    inferred: "推斷",
    category: "分類",
    affectedUrls: "受影響網址",
    externalAffectedUrls: "本次掃描外的受影響網址",
    externalAffectedUrlsHelp: "這些網址來自 Google 證據或歷史比較，但不在目前已掃描 URL 清單中。",
    impact: "影響",
    evidence: "證據",
    fixSteps: "修復步驟",
    verifySteps: "驗證",
    tasks: "\u9805\u4efb\u52d9",
    showAllIssues: "顯示全部問題",
    showFewerIssues: "收起問題",
...
export const privacyDataText = {
  en: {
    ...
    apiUnavailable: "Session data API is not available in this deployment. Local browser settings still work; run the Node API service to manage retained tasks and server-side session data.",
  },
  "zh-CN": {
    title: "\u9690\u79c1\u4e0e\u5df2\u4fdd\u5b58\u6570\u636e",
    ...
    apiUnavailable: "\u5f53\u524d\u90e8\u7f72\u672a\u63d0\u4f9b\u4f1a\u8bdd\u6570\u636e API\u3002\u672c\u5730\u6d4f\u89c8\u5668\u8bbe\u7f6e\u4ecd\u53ef\u6b63\u5e38\u4f7f\u7528\uff1b\u5982\u9700\u7ba1\u7406\u4fdd\u7559\u4efb\u52a1\u548c\u670d\u52a1\u7aef\u4f1a\u8bdd\u6570\u636e\uff0c\u8bf7\u540c\u65f6\u8fd0\u884c Node API \u670d\u52a1\u3002",
  },
  "zh-TW": {
    title: "\u96b1\u79c1\u8207\u5df2\u5132\u5b58\u8cc7\u6599",
    ...
    apiUnavailable: "\u76ee\u524d\u90e8\u7f72\u672a\u63d0\u4f9b\u5de5\u4f5c\u968e\u6bb5\u8cc7\u6599 API\u3002\u672c\u6a5f\u700f\u89bd\u5668\u8a2d\u5b9a\u4ecd\u53ef\u6b63\u5e38\u4f7f\u7528\uff1b\u5982\u9700\u7ba1\u7406\u4fdd\u7559\u4efb\u52d9\u548c\u4f3a\u670d\u5668\u7aef\u5de5\u4f5c\u968e\u6bb5\u8cc7\u6599\uff0c\u8acb\u540c\u6642\u57f7\u884c Node API \u670d\u52d9\u3002",
  },
};
...
export const gscUiText = {
  en: {
    ...
    oauthDocsLabel: "Search Console OAuth authorization",
    enableApiDocsLabel: "Enable Search Console API",
    gscStartDocsLabel: "Search Console setup guide",
    ...
    connectionHelp: "Connect Search Console to load sitemap status, Search Analytics, and URL Inspection.",
  ...
  "zh-CN": {
    ...
    oauthDocsLabel: "Search Console OAuth 授权说明",
    enableApiDocsLabel: "启用 Search Console API",
    gscStartDocsLabel: "Search Console 开通指南",
    ...
    connectionHelp: "连接 Search Console 后可加载 Sitemap 状态、Search Analytics 和网址检查。",
  ...
  "zh-TW": {
    ...
    oauthDocsLabel: "Search Console OAuth 授權說明",
    enableApiDocsLabel: "啟用 Search Console API",
    gscStartDocsLabel: "Search Console 啟用指南",
    ...
    connectionHelp: "連接 Search Console 後可載入 Sitemap 狀態、Search Analytics 和網址檢查。",
...
export const gscDataText = {
  en: {
    ...
    queryIntentSettings: "Query intent settings", brandTerms: "Brand terms", localTerms: "Location terms",
    excludeTerms: "Excluded clustering terms", queryTermsPlaceholder: "Comma-separated terms",
    queryIntentSettingsHelp: "Saved in this browser for the selected property. Excluded terms remain in raw data but do not participate in cannibalization clustering.",
    ...
    evidence: "Evidence", evidenceDays: "days", evidenceMinimum: "minimum impressions",
    evidenceCtrBenchmark: "conservative CTR benchmark", evidenceCtrUpper: "90% CTR upper bound", evidenceSecondShare: "second-page share",
    ...
    inspectionRemainingBatches: "remaining batches", inspectionQuotaNote: "Each request checks at most {batchSize} URLs; the next request will check up to {nextBatch}. Google applies property-level API quotas.",
    inspectionSkippedReasons: "Queue scope and skipped sources", inspectionSkipConnection: "Search Console is not connected, so the queue cannot run.",
    inspectionSkipProperty: "No Search Console property is selected.", inspectionSkipGscRows: "Search Analytics page rows are not loaded, so GSC-only URLs are not in this queue.",
    inspectionSkipInternal: "Recursive internal discovery was disabled, so URLs found only beyond scanned sitemap pages are not included.",
    inspectionSkipHistoryComparison: "No historical comparison is selected, so new-page and regression priority signals are not included.",
    inspectionSkipHistorySnapshot: "The selected legacy history entry has no page URL snapshot; issue regressions are prioritized, but clean new pages cannot be identified.",
    inspectionSkipTruncated: "The audit reached a sitemap, URL, or internal-discovery limit, so this queue covers only the saved scan scope.",
    inspectionSkipNoCandidates: "No valid HTTP(S) URL candidates were produced by the current audit scope.",
    sourceGscShort: "GSC", sourceInternalShort: "Internal", candidateTechnical: "Technical blocker",
    sourceHistoryShort: "History", candidateHistoryWorsened: "Issue severity worsened since the comparison scan",
    candidateHistoryIntroduced: "New issue since the comparison scan", candidateHistoryNewPage: "New page since the comparison scan",
    ...
    sitemapsTitle: "Google sitemap status", sitemapsLoad: "Load sitemap status", sitemapsReload: "Reload", sitemapsLoading: "Loading...",
    ...
    sitemapsProperty: "Property", sitemapsPropertyMismatch: "Google returned sitemap data for a different property. Reload after confirming the selected property.",
    ...
    sitemapsCurrentMissing: "Google's submitted sitemap list does not contain this exact audit sitemap URL. This does not mean the sitemap is invalid or its pages are not indexed.", sitemapsNoData: "Google returned no submitted sitemaps.",
  ...
  "zh-CN": {
    ...
    queryIntentSettings: "查询意图设置", brandTerms: "品牌词", localTerms: "地区词",
    excludeTerms: "聚类排除词", queryTermsPlaceholder: "使用逗号分隔多个词",
    queryIntentSettingsHelp: "按当前 Property 保存在此浏览器中。排除词仍保留在原始数据里，但不参与关键词蚕食聚类。",
    ...
    evidence: "证据", evidenceDays: "天", evidenceMinimum: "最低展示次数",
    evidenceCtrBenchmark: "保守点击率基准", evidenceCtrUpper: "90% 点击率上界", evidenceSecondShare: "第二页面展示占比",
    ...
    inspectionRemainingBatches: "剩余批次", inspectionQuotaNote: "每次请求最多检查 {batchSize} 个网址；下一次最多检查 {nextBatch} 个。Google 还会按 property 应用 API 配额。",
    inspectionSkippedReasons: "队列范围与跳过来源", inspectionSkipConnection: "尚未连接 Search Console，因此当前队列不能执行。",
    inspectionSkipProperty: "尚未选择 Search Console property。", inspectionSkipGscRows: "尚未加载 Search Analytics 网页数据，因此队列不包含仅出现在 GSC 的网址。",
    inspectionSkipInternal: "未启用递归站内发现，因此未包含只在 sitemap 扫描范围之外发现的网址。",
    inspectionSkipHistoryComparison: "尚未选择历史对比版本，因此队列未加入新页面和回归问题优先信号。",
    inspectionSkipHistorySnapshot: "所选旧历史记录没有页面网址快照；仍会优先回归问题，但无法识别没有问题的新页面。",
    inspectionSkipTruncated: "本次检查达到 sitemap、网址或站内发现上限，因此队列只覆盖已保存的扫描范围。",
    inspectionSkipNoCandidates: "当前扫描范围没有生成有效的 HTTP(S) 候选网址。",
    sourceGscShort: "GSC", sourceInternalShort: "站内发现", candidateTechnical: "存在技术阻挡",
    sourceHistoryShort: "历史对比", candidateHistoryWorsened: "相较对比版本，问题严重度已恶化",
    candidateHistoryIntroduced: "相较对比版本出现了新问题", candidateHistoryNewPage: "相较对比版本新增的页面",
    ...
    sitemapsTitle: "Google Sitemap 状态", sitemapsLoad: "加载 Sitemap 状态", sitemapsReload: "重新加载", sitemapsLoading: "加载中...",
    sitemapsHelp: "显示该 Search Console property 已提交的 sitemap、Google 最后读取时间以及错误和警告。",
    sitemapsProperty: "Property", sitemapsPropertyMismatch: "Google 返回了其它 Property 的 Sitemap 数据。请确认当前 Property 后重新加载。",
    ...
    sitemapsCurrentMissing: "Google 返回的已提交 Sitemap 列表中没有当前扫描的精确网址；这不表示 Sitemap 无效，也不表示其中网页未收录。", sitemapsNoData: "Google 没有返回已提交的 sitemap。",
  ...
  "zh-TW": {
    ...
    queryIntentSettings: "查詢意圖設定", brandTerms: "品牌詞", localTerms: "地區詞",
    excludeTerms: "聚類排除詞", queryTermsPlaceholder: "使用逗號分隔多個詞",
    queryIntentSettingsHelp: "依目前 Property 儲存在此瀏覽器中。排除詞仍保留於原始資料，但不參與關鍵字蠶食聚類。",
    ...
    evidence: "證據", evidenceDays: "天", evidenceMinimum: "最低曝光次數",
    evidenceCtrBenchmark: "保守點閱率基準", evidenceCtrUpper: "90% 點閱率上界", evidenceSecondShare: "第二個頁面曝光占比",
    ...
    inspectionRemainingBatches: "剩餘批次", inspectionQuotaNote: "每次請求最多檢查 {batchSize} 個網址；下一次最多檢查 {nextBatch} 個。Google 仍會依 property 套用 API 配額。",
    inspectionSkippedReasons: "佇列範圍與略過來源", inspectionSkipConnection: "尚未連接 Search Console，因此目前佇列無法執行。",
    inspectionSkipProperty: "尚未選擇 Search Console property。", inspectionSkipGscRows: "尚未載入 Search Analytics 網頁資料，因此佇列不包含只出現在 GSC 的網址。",
    inspectionSkipInternal: "未啟用遞迴站內探索，因此未包含只在 sitemap 掃描範圍之外發現的網址。",
    inspectionSkipHistoryComparison: "尚未選擇歷史對比版本，因此佇列未加入新頁面和回歸問題優先訊號。",
    inspectionSkipHistorySnapshot: "所選舊歷史記錄沒有頁面網址快照；仍會優先回歸問題，但無法識別沒有問題的新頁面。",
    inspectionSkipTruncated: "本次檢查達到 sitemap、網址或站內探索上限，因此佇列只涵蓋已儲存的掃描範圍。",
    inspectionSkipNoCandidates: "目前掃描範圍沒有產生有效的 HTTP(S) 候選網址。",
    sourceGscShort: "GSC", sourceInternalShort: "站內發現", candidateTechnical: "存在技術阻擋",
    sourceHistoryShort: "歷史對比", candidateHistoryWorsened: "相較對比版本，問題嚴重度已惡化",
    candidateHistoryIntroduced: "相較對比版本出現了新問題", candidateHistoryNewPage: "相較對比版本新增的頁面",
    ...
    sitemapsTitle: "Google Sitemap 狀態", sitemapsLoad: "載入 Sitemap 狀態", sitemapsReload: "重新載入", sitemapsLoading: "載入中...",
    sitemapsHelp: "顯示該 Search Console property 已提交的 sitemap、Google 最後讀取時間以及錯誤和警告。",
    sitemapsProperty: "Property", sitemapsPropertyMismatch: "Google 回傳了其它 Property 的 Sitemap 資料。請確認目前 Property 後重新載入。",
    ...
    sitemapsCurrentMissing: "Google 回傳的已提交 Sitemap 清單中沒有目前掃描的精確網址；這不表示 Sitemap 無效，也不表示其中網頁未收錄。", sitemapsNoData: "Google 沒有回傳已提交的 sitemap。",
...
export const pageSpeedText = {
  en: {
    title: "PageSpeed Insights", help: "Run an on-demand Google Lighthouse test for one scanned URL. This is separate from soos lightweight HTML performance checks.",
    onDemand: "on demand", apiKey: "Google API key", apiKeyPlaceholder: "Uses the server preset when empty",
    apiKeyHelp: "Uses the deployment preset by default. Add your own key in Settings when the shared free quota is exhausted.",
    settingsTitle: "Google API keys", settingsHelp: "Use one shared Google API key for PageSpeed/CrUX, or set a PageSpeed-only key. Search Console data still requires OAuth access to the verified property.",
    sharedApiKey: "Shared Google API key", sharedApiKeyPlaceholder: "Optional shared key for Google APIs",
    pageSpeedApiKey: "PageSpeed-only API key", pageSpeedApiKeyPlaceholder: "Optional override for PageSpeed and CrUX",
    usingCustomKey: "Using your PageSpeed key", usingSharedKey: "Using your shared Google key", usingDefaultKey: "Using the server preset key", noApiKey: "No key configured",
    applyApiKey: "Create API key", enablePageSpeedApi: "Enable PageSpeed API", enableSearchConsoleApi: "Enable Search Console API", gscAuthGuide: "GSC OAuth guide", enableGscGuide: "GSC setup guide",
    testUrl: "Test URL", strategy: "Strategy", mobile: "Mobile", desktop: "Desktop",
    run: "Run PageSpeed", running: "Running PageSpeed...", clearKey: "Clear key", failed: "PageSpeed analysis failed",
    privacy: "The selected URL and active API key are sent through the soos server to Google PageSpeed Insights and, when selected, Chrome UX Report. A user-entered key is kept only in session storage and is not saved in reports, history, logs, or Neon.",
    performanceScore: "Performance", seoScore: "Lighthouse SEO", finalUrl: "Final URL", analyzedAt: "Analyzed",
    labTitle: "Lighthouse lab data", labHelp: "A simulated test that can vary between runs. It is not real-user performance data.",
    cruxTitle: "Chrome UX Report field data", cruxHelp: "Daily-updated, 28-day real-user aggregates. Page data falls back to origin data only when the page has insufficient samples.",
    includeCrux: "Also load dedicated CrUX field data", cruxFailed: "Chrome UX Report analysis failed", noCruxData: "CrUX has insufficient page and origin samples for this URL.",
    cruxApiNotEnabled: "Chrome UX Report API is not enabled for this Google Cloud project.",
    cruxEnableWait: "Enable the API for the project used by this key, wait a few minutes, then retry. The PageSpeed result above remains valid.",
    enableCruxApi: "Enable CrUX API", retryCrux: "Retry",
    collectionPeriod: "Collection period", good: "Good", "needs-improvement": "Needs improvement", poor: "Poor",
    "insufficient-data": "Insufficient data", passed: "Core Web Vitals passed", failed: "Core Web Vitals failed",
    fieldDataTitle: "Core Web Vitals field data", cruxSource: "Dedicated CrUX API", pagespeedFieldSource: "PageSpeed field-data fallback",
    fieldTitle: "PageSpeed field data (legacy)", fieldHelp: "Field data still returned by PageSpeed Insights, kept separate for comparison during Google's deprecation period.",
    pageFieldData: "Page-level data", originFallback: "Origin-level fallback", noFieldData: "Google did not return sufficient field data for this URL or origin.",
    fieldDeprecation: "Google plans to remove this field-data copy from PageSpeed Insights. Use the dedicated Chrome UX Report section above as the long-term source.",
    opportunities: "Lighthouse opportunities", performanceDiagnostics: "Performance diagnostics",
    seoAudits: "Lighthouse SEO findings", seoAuditsHelp: "Failed and manual Lighthouse SEO checks for this rendered test run.",
    noSeoFailures: "No failed Lighthouse SEO checks were returned.", failedAudit: "Failed", review: "Review",
    runWarnings: "Run warnings", redirected: "PageSpeed tested a redirected URL", runtime: "Run time",
    lcp: "LCP", cls: "CLS", inp: "INP", fcp: "FCP", ttfb: "TTFB", tbt: "TBT", tti: "TTI", speedIndex: "Speed Index",
    unknown: "Unknown",
  },
  "zh-CN": {
    title: "PageSpeed Insights", help: "为一个已扫描网址按需运行 Google Lighthouse 测试，与 soos 的轻量 HTML 性能检查分开显示。",
    onDemand: "按需运行", apiKey: "Google API 密钥", apiKeyPlaceholder: "留空则使用服务端预设",
    apiKeyHelp: "默认使用部署环境中的预设密钥；共享免费额度不足时，可在设置中填入自己的密钥。",
    settingsTitle: "Google API 密钥", settingsHelp: "可用一个 Google API Key 共用给 PageSpeed/CrUX，也可以单独设置 PageSpeed 专用 Key。Search Console 真实数据仍需要 OAuth 授权访问已验证 property。",
    sharedApiKey: "通用 Google API Key", sharedApiKeyPlaceholder: "可选：Google API 共用密钥",
    pageSpeedApiKey: "PageSpeed 专用 API Key", pageSpeedApiKeyPlaceholder: "可选：覆盖 PageSpeed 和 CrUX",
    usingCustomKey: "正在使用 PageSpeed 专用密钥", usingSharedKey: "正在使用通用 Google 密钥", usingDefaultKey: "正在使用服务端预设密钥", noApiKey: "尚未配置密钥",
    applyApiKey: "申请 API Key", enablePageSpeedApi: "启用 PageSpeed API", enableSearchConsoleApi: "启用 Search Console API", gscAuthGuide: "GSC OAuth 指南", enableGscGuide: "GSC 设置指南",
    testUrl: "测试网址", strategy: "测试设备", mobile: "移动端", desktop: "桌面端",
    run: "运行 PageSpeed", running: "PageSpeed 运行中...", clearKey: "清除密钥", failed: "PageSpeed 分析失败",
    privacy: "所选网址和当前生效的 API 密钥会经 soos 服务端发送给 Google PageSpeed Insights；勾选后也会发送给 Chrome UX Report。用户输入的密钥仅保存在会话存储，不写入报告、历史、日志或 Neon。",
    performanceScore: "性能", seoScore: "Lighthouse SEO", finalUrl: "最终网址", analyzedAt: "分析时间",
    labTitle: "Lighthouse 实验室数据", labHelp: "模拟环境测试，每次结果可能波动，不等同于真实用户性能。",
    cruxTitle: "Chrome UX Report 真实用户数据", cruxHelp: "按日更新的 28 天真实用户聚合数据；仅当网页样本不足时才回退到来源（origin）级数据。",
    includeCrux: "同时加载独立 CrUX 真实用户数据", cruxFailed: "Chrome UX Report 分析失败", noCruxData: "CrUX 没有为此网址返回足够的网页级或来源级样本。",
    cruxApiNotEnabled: "此 Google Cloud 项目尚未启用 Chrome UX Report API。",
    cruxEnableWait: "请为该 API 密钥所属项目启用此 API，等待几分钟后重试。上方 PageSpeed 结果仍然有效。",
    enableCruxApi: "启用 CrUX API", retryCrux: "重试",
    collectionPeriod: "采集区间", good: "良好", "needs-improvement": "需要改善", poor: "较差",
    "insufficient-data": "样本不足", passed: "Core Web Vitals 通过", failed: "Core Web Vitals 未通过",
    fieldDataTitle: "Core Web Vitals 真实用户数据", cruxSource: "独立 CrUX API", pagespeedFieldSource: "PageSpeed 真实用户数据回退",
    fieldTitle: "PageSpeed 真实用户数据（旧接口）", fieldHelp: "PageSpeed Insights 目前仍返回的真实用户数据；Google 停用该字段期间仅用于分层对照。",
    pageFieldData: "网页级数据", originFallback: "来源（origin）级回退", noFieldData: "Google 没有为此网址或来源返回足够的真实用户数据。",
    fieldDeprecation: "Google 计划从 PageSpeed Insights API 移除此份数据。长期判断请以上方独立 Chrome UX Report 数据为准。",
    opportunities: "Lighthouse 优化机会", performanceDiagnostics: "性能诊断",
    seoAudits: "Lighthouse SEO 问题", seoAuditsHelp: "本次渲染测试中未通过及需要人工确认的 Lighthouse SEO 检查。",
    noSeoFailures: "Lighthouse 没有返回未通过的 SEO 检查。", failedAudit: "未通过", review: "检查",
    runWarnings: "运行警告", redirected: "PageSpeed 测试了重定向后的网址", runtime: "运行耗时",
    lcp: "LCP", cls: "CLS", inp: "INP", fcp: "FCP", ttfb: "TTFB", tbt: "TBT", tti: "TTI", speedIndex: "速度指数",
    unknown: "未知",
  },
  "zh-TW": {
    title: "PageSpeed Insights", help: "為一個已掃描網址按需執行 Google Lighthouse 測試，與 soos 的輕量 HTML 效能檢查分開顯示。",
    onDemand: "按需執行", apiKey: "Google API 金鑰", apiKeyPlaceholder: "留空則使用伺服器預設",
    apiKeyHelp: "預設使用部署環境中的預設金鑰；共用免費額度不足時，可在設定中填入自己的金鑰。",
    settingsTitle: "Google API 金鑰", settingsHelp: "可用一個 Google API Key 共用給 PageSpeed/CrUX，也可以單獨設定 PageSpeed 專用 Key。Search Console 真實資料仍需要 OAuth 授權存取已驗證 property。",
    sharedApiKey: "共用 Google API Key", sharedApiKeyPlaceholder: "選用：Google API 共用金鑰",
    pageSpeedApiKey: "PageSpeed 專用 API Key", pageSpeedApiKeyPlaceholder: "選用：覆寫 PageSpeed 和 CrUX",
    usingCustomKey: "正在使用 PageSpeed 專用金鑰", usingSharedKey: "正在使用共用 Google 金鑰", usingDefaultKey: "正在使用伺服器預設金鑰", noApiKey: "尚未設定金鑰",
    applyApiKey: "申請 API Key", enablePageSpeedApi: "啟用 PageSpeed API", enableSearchConsoleApi: "啟用 Search Console API", gscAuthGuide: "GSC OAuth 指南", enableGscGuide: "GSC 設定指南",
    testUrl: "測試網址", strategy: "測試裝置", mobile: "行動裝置", desktop: "桌面裝置",
    run: "執行 PageSpeed", running: "PageSpeed 執行中...", clearKey: "清除金鑰", failed: "PageSpeed 分析失敗",
    privacy: "所選網址與目前生效的 API 金鑰會經 soos 伺服器傳送給 Google PageSpeed Insights；勾選後也會傳送給 Chrome UX Report。使用者輸入的金鑰僅存於工作階段儲存空間，不寫入報告、歷史、日誌或 Neon。",
    performanceScore: "效能", seoScore: "Lighthouse SEO", finalUrl: "最終網址", analyzedAt: "分析時間",
    labTitle: "Lighthouse 實驗室資料", labHelp: "模擬環境測試，每次結果可能波動，不等同於真實使用者效能。",
    cruxTitle: "Chrome UX Report 真實使用者資料", cruxHelp: "每日更新的 28 天真實使用者彙總資料；僅在網頁樣本不足時才改用來源（origin）層級資料。",
    includeCrux: "同時載入獨立 CrUX 真實使用者資料", cruxFailed: "Chrome UX Report 分析失敗", noCruxData: "CrUX 沒有為此網址回傳足夠的網頁層級或來源層級樣本。",
    cruxApiNotEnabled: "此 Google Cloud 專案尚未啟用 Chrome UX Report API。",
    cruxEnableWait: "請為該 API 金鑰所屬專案啟用此 API，等待幾分鐘後重試。上方 PageSpeed 結果仍然有效。",
    enableCruxApi: "啟用 CrUX API", retryCrux: "重試",
    collectionPeriod: "收集期間", good: "良好", "needs-improvement": "需要改善", poor: "不佳",
    "insufficient-data": "樣本不足", passed: "Core Web Vitals 通過", failed: "Core Web Vitals 未通過",
    fieldDataTitle: "Core Web Vitals 真實使用者資料", cruxSource: "獨立 CrUX API", pagespeedFieldSource: "PageSpeed 真實使用者資料備援",
    fieldTitle: "PageSpeed 真實使用者資料（舊介面）", fieldHelp: "PageSpeed Insights 目前仍回傳的真實使用者資料；Google 停用此欄位期間僅用於分層比較。",
    pageFieldData: "網頁層級資料", originFallback: "來源（origin）層級備援", noFieldData: "Google 沒有為此網址或來源回傳足夠的真實使用者資料。",
    fieldDeprecation: "Google 計畫從 PageSpeed Insights API 移除此份資料。長期判斷請以上方獨立 Chrome UX Report 資料為準。",
    opportunities: "Lighthouse 最佳化機會", performanceDiagnostics: "效能診斷",
    seoAudits: "Lighthouse SEO 問題", seoAuditsHelp: "本次轉譯測試中未通過及需要人工確認的 Lighthouse SEO 檢查。",
    noSeoFailures: "Lighthouse 沒有回傳未通過的 SEO 檢查。", failedAudit: "未通過", review: "檢查",
    runWarnings: "執行警告", redirected: "PageSpeed 測試了重新導向後的網址", runtime: "執行耗時",
    lcp: "LCP", cls: "CLS", inp: "INP", fcp: "FCP", ttfb: "TTFB", tbt: "TBT", tti: "TTI", speedIndex: "速度指數",
    unknown: "未知",
  },
};
...
export const gscSupportingText = {
  en: {
    ...
    csvFallback: "Use this only when Search Console is not connected. Connecting the API replaces imported CSV data.",
  ...
  "zh-CN": {
    ...
    csvFallback: "仅在未连接 Search Console 时使用。连接 API 后会改用在线数据，并清除已导入的 CSV 数据。",
  ...
  "zh-TW": {
    ...
    csvFallback: "僅在未連接 Search Console 時使用。連接 API 後會改用線上資料，並清除已匯入的 CSV 資料。",
