...
export const pageSpeedText = {
  en: {
    ...
    settingsTitle: "PageSpeed API key", settingsHelp: "Optional session-only override for PageSpeed Insights and CrUX. Empty uses SOOS_PAGESPEED_API_KEY or SOOS_CRUX_API_KEY from the server environment.",
    usingCustomKey: "Using your session key", usingDefaultKey: "Using the server preset key", noApiKey: "No key configured",
    applyApiKey: "Create API key", enablePageSpeedApi: "Enable PageSpeed API", enableGscGuide: "Enable GSC guide",
  ...
  "zh-CN": {
    ...
    settingsTitle: "PageSpeed API 密钥", settingsHelp: "可选的会话级覆盖密钥，用于 PageSpeed Insights 和 CrUX。留空时使用服务端环境变量 SOOS_PAGESPEED_API_KEY 或 SOOS_CRUX_API_KEY。",
    usingCustomKey: "正在使用你的会话密钥", usingDefaultKey: "正在使用服务端预设密钥", noApiKey: "尚未配置密钥",
    applyApiKey: "申请 API Key", enablePageSpeedApi: "启用 PageSpeed API", enableGscGuide: "开启 GSC 指南",
  ...
  "zh-TW": {
    ...
    settingsTitle: "PageSpeed API 金鑰", settingsHelp: "選用的工作階段覆寫金鑰，用於 PageSpeed Insights 和 CrUX。留空時使用伺服器環境變數 SOOS_PAGESPEED_API_KEY 或 SOOS_CRUX_API_KEY。",
    usingCustomKey: "正在使用你的工作階段金鑰", usingDefaultKey: "正在使用伺服器預設金鑰", noApiKey: "尚未設定金鑰",
    applyApiKey: "申請 API Key", enablePageSpeedApi: "啟用 PageSpeed API", enableGscGuide: "啟用 GSC 指南",
